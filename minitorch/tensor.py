...
class Tensor:
    ...
    def is_close(self, b: Tensor) -> Tensor:
        """Return if tensor b is close in value to this tensor"""
    ...
    def mean(self, dim: Optional[int] = None) -> Tensor:
        """Mean tensor over dimension. If no dimension is provided, mean all elements."""
        if dim is not None:
    ...
    def zero_grad_(self) -> None:
        """Zeroes out the gradient of the tensor"""
        self.grad = None
